...
import { AiOutlineClose } from 'react-icons/ai'; // Or use X from lucide-react if you prefer
...
function Dashboard() {
  ...
  const fetchStats = async () =>{
      ...
      const response = await axios.get(
        'http://127.0.0.1:8000/api/inventorystats/'
      )
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50">
        ...
        <p className="text-gray-600 font-medium">Fetching inventory data...</p>
      </div>
    );
  }
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-500">Real-time inventory insights</p>
        </div>
        <button 
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
        {[
          ...
          <div key={i} className={` p-6 rounded-2xl shadow-sm border border-gray-100 transition-hover hover:shadow-md
           ${s.label === "Total Items" ? "bg-linear-to-r from-blue-500 to-purple-500" : "bg-white" }`}>
            ...
            <h3 className="text-2xl font-bold text-gray-800">{s.val}</h3>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          <h2 className="font-bold text-gray-800 mb-6">Stock Volume by Category</h2>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          <h2 className="font-bold text-gray-800 mb-6">Inventory Value Distribution</h2>
          <div className="h-[300px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
         <div className="lg:col-span-2 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            <h2 className="font-bold text-gray-800 mb-6">Stock Trends (Added vs Sold)</h2>
         ...
         <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            <h2 className="font-bold text-gray-800 mb-4">Low Stock Warnings</h2>
